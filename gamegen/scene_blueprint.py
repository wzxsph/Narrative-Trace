...
def build_scene_blueprint_design(
    ...
    scene_specs = [
        scene_blueprint(
            ...
            ["clues.unsent_warning", "clues.station_location", "relationships.chen.trust"],
            ["obs_unsent_sms", "obs_0213_log"],
            ["choice_call_chen", "choice_go_station", "choice_inspect_without_calling"],
            ["ch01_cloud_console"],
        ),
        scene_blueprint(
            "ch01_cloud_console",
            ...
            ["clues.wipe_pause_window", "clues.freeze_token", "pressure.company_alert"],
            ["obs_remote_wipe", "obs_pause_window", "obs_session_token"],
            ["choice_freeze_wipe", "choice_isolate_phone", "choice_delay_wipe"],
            ["ch01_contact_trace"],
        ),
        scene_blueprint(
            "ch01_contact_trace",
            ...
            ["relationships.chen.trust", "relationships.chen.suspicion"],
            ["obs_call_history", "obs_trimmed_gap"],
            ["choice_leave_for_station", "choice_send_voice_to_self", "choice_confront_chen"],
            ["ch02_station_gate"],
        ),
        scene_blueprint(
            "ch02_station_gate",
            ...
            ["obs_station_entry_code", "obs_camera_sweep"],
            ["choice_enter_service_corridor", "choice_wait_guard_shift", "choice_cover_camera"],
        ...
        scene_blueprint(
            ...
            ["clues.locker_a17", "clues.victim_list", "relationships.lin.bond"],
            ["obs_locker_code", "obs_red_bracelet", "obs_victim_list"],
            ["choice_open_locker", "choice_record_platform", "choice_leave_cache"],
            ["ch02_locker_room"],
        ),
        scene_blueprint(
            "ch02_locker_room",
            ...
            ["clues.backup_copy", "relationships.lin.bond"],
            ["obs_backup_drive", "obs_last_note"],
            ["choice_take_backup_to_safehouse", "choice_call_chen_from_station", "choice_copy_then_leave"],
            ["ch03_backup_unlock"],
        ),
        scene_blueprint(
            "ch03_backup_unlock",
            ...
            ["clues.public_packet_ready", "clues.archive_ready"],
            ["obs_backup_context", "obs_confession_cut"],
            ["choice_compare_context", "choice_prepare_archive", "choice_prepare_public_packet"],
            ["ch03_witness_thread"],
        ),
        scene_blueprint(
            "ch03_witness_thread",
            ...
            ["clues.chen_message_ready", "relationships.chen.trust", "relationships.chen.suspicion"],
            ["obs_send_to_chen", "obs_lin_request"],
            ["choice_ask_chen_last_time", "choice_protect_lin_secret", "choice_confront_final"],
