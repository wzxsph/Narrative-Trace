...
1. 增加第一章轻教学，明确“文字可以展开”和“观察会解锁行动”，但必须通过叙事内提示完成，避免像系统说明。
2. 把章节复盘从“轻量列表”升级为更接近 flowchart 的节点关系复盘。
3. 增强 NPC 关系回声：关键关系变量至少在 2 个后续节点有文本反馈。
4. 建立内部测试记录模板，用用户反馈验证第 14 节成功标准。
5. 检查 9 场景内容节奏，删掉只是在“加长度”的场景，保留真正改变理解或行动的场景。
